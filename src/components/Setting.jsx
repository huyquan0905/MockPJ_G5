    ...
    return (
        <div className='contentSt'>
            ...
            <form className='formSt'>
                <input type="text" name="" value={'https://api.realworld.io/images/smiley-cyrus.jpeg'} id="" />
                <input type="text" placeholder='Username' id="" />
                <textarea style={{marginBottom:'15px'}}  cols="30" rows="10" placeholder='Short bio about you'></textarea>
